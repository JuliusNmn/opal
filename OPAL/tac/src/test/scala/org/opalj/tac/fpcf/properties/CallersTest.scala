...
class CallersTest extends AnyFlatSpec with Matchers {
    ...
    it should "update correctly" in {
        ...
        val oneCaller = NoCallers.updated(
            SimpleContext(otherMethod), SimpleContext(declaredMethod), pc = 0, isDirect = true
        )
    ...
    it should "behave correctly" in {
        ...
        assert(NoCallers.callers(otherMethod)(typeProvider = null).isEmpty)
    ...
    it should "behave correctly" in {
        ...
        assert(OnlyVMLevelCallers.callers(otherMethod)(typeProvider = null).isEmpty)
    ...
    it should "behave correctly" in {
        ...
        assert(OnlyCallersWithUnknownContext.callers(otherMethod)(typeProvider = null).isEmpty)
    ...
    it should "behave correctly" in {
        ...
        assert(OnlyVMCallersAndWithUnknownContext.callers(otherMethod)(typeProvider = null).isEmpty)
    ...
    it should "update correctly" in {
        ...
        val withTwoCallers = callers.updated(
            SimpleContext(otherMethod), SimpleContext(otherMethod), pc = 1, isDirect = true
        )
