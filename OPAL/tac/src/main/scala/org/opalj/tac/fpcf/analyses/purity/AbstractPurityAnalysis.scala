...
trait AbstractPurityAnalysis extends FPCFAnalysis {
    ...
    protected[this] implicit val typeProvider: TypeProvider = CallGraphKey.typeProvider
    ...
    def baseMethodPurity(context: Context): ProperPropertyComputationResult = {
        ...
        c(propertyStore(SimpleContext(declaredMethods(context.method.definedMethod)), Purity.key))
    }
